...
__MEMPOOL_POOLS_REINDEX_START_HEIGHT__=${MEMPOOL_POOLS_REINDEX_START_HEIGHT:=-1}
...
sed -i "s!__MEMPOOL_POOLS_REINDEX_START_HEIGHT__!${__MEMPOOL_POOLS_REINDEX_START_HEIGHT__}!g" mempool-config.json
