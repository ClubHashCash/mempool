...
__MEMPOOL_UNFURLER_HTTP_HOST__=${MEMPOOL_UNFURLER_HTTP_HOST:=mempool-unfurler}
__MEMPOOL_UNFURLER_HTTP_PORT__=${MEMPOOL_UNFURLER_HTTP_PORT:=4201}
...
sed -i "s/__MEMPOOL_UNFURLER_HTTP_HOST__/${__MEMPOOL_UNFURLER_HTTP_HOST__}/g" /etc/nginx/conf.d/nginx-mempool.conf
sed -i "s/__MEMPOOL_UNFURLER_HTTP_PORT__/${__MEMPOOL_UNFURLER_HTTP_PORT__}/g" /etc/nginx/conf.d/nginx-mempool.conf
