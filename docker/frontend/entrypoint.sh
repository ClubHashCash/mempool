...
__MEMPOOL_OG_RENDERER_HTTP_HOST__=${MEMPOOL_OG_RENDERER_HTTP_HOST:=mempool-og-renderer}
__MEMPOOL_OG_RENDERER_HTTP_PORT__=${MEMPOOL_OG_RENDERER_HTTP_PORT:=8081}
...
sed -i "s/__MEMPOOL_OG_RENDERER_HTTP_HOST__/${__MEMPOOL_OG_RENDERER_HTTP_HOST__}/g" /etc/nginx/conf.d/nginx-mempool.conf
sed -i "s/__MEMPOOL_OG_RENDERER_HTTP_PORT__/${__MEMPOOL_OG_RENDERER_HTTP_PORT__}/g" /etc/nginx/conf.d/nginx-mempool.conf
