...
export const electrumApiDocsData = [
  ...
  },
  {
    ...
    description: {
      default: 'Returns the estimated transaction fee for confirmation within a given number of blocks. Returns fee in HCASH/kB, or -1 if estimation is not available.'
    },
    showConditions: bitcoinNetworks.concat(liquidNetworks),
  ...
  },
  {
    ...
    description: {
      default: 'Returns the minimum relay fee for low-priority transactions in HCASH/kB.'
    },
    showConditions: bitcoinNetworks.concat(liquidNetworks),
