...
export class BlockFeeRatesGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.bitcoin.graphs.block-fee-rates:See HashCash feerates visualized over time, including minimum and maximum feerates per block along with feerates at various percentiles.`);
