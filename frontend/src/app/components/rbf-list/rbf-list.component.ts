...
export class RbfList implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription($localize`:@@meta.description.rbf-list:See the most recent RBF replacements on the HashCash${seoDescriptionNetwork(this.stateService.network)} network, updated in real-time.`);
