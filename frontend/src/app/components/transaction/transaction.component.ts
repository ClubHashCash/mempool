...
export class TransactionComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  acceleratorAvailable: boolean = this.stateService.env.ACCELERATOR && this.stateService.env.ACCELERATOR_BUTTON && this.stateService.network === '';
  ...
  ngOnInit() {
    ...
    this.stateService.networkChanged$.subscribe(
      (network) => {
        ...
        this.acceleratorAvailable = this.stateService.env.ACCELERATOR && this.stateService.env.ACCELERATOR_BUTTON && this.stateService.network === '';
      }
    );
    ...
    this.subscription = this.zoneService.wrapObservable(this.route.paramMap
      .pipe(
        switchMap((params: ParamMap) => {
          ...
          const network = this.stateService.network === 'liquid' || this.stateService.network === 'liquidtestnet' ? 'Liquid' : 'HashCash';
