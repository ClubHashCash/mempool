...
export class PoolRankingComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.bitcoin.graphs.pool-ranking:See the top HashCash mining pools ranked by number of blocks mined, over your desired timeframe.`);
