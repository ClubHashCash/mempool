...
export class HashrateChartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.widget) {
      ...
      this.seoService.setDescription($localize`:@@meta.description.bitcoin.graphs.hashrate:See hashrate and difficulty for the HashCash${seoDescriptionNetwork(this.network)} network visualized over time.`);
