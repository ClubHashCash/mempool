...
class Server {
  ...
  async renderUnfurlMeta(rawPath: string): Promise<string> {
    ...
    let ogTitle = 'HashCash Mempool';
    let ogDescription = 'Explore the full HashCash ecosystem with HashCash Mempool';
...
<html lang="en-US" dir="ltr">
  <head>
    ...
    <meta property="twitter:site" content="@clubhashcash">
    <meta property="twitter:creator" content="@clubhashcash">
    <meta property="twitter:title" content="${ogTitle}">
    <meta property="twitter:description" content="${ogDescription}"/>
    <meta property="twitter:image:src" content="${ogImageUrl}"/>
    <meta property="twitter:domain" content="mempool.hashcash-test.network">
  </head>
  <body></body>
</html>`;
  }
