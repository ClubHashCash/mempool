...
const routes = {
  ...
  enterprise: {
    title: "HashCash Mempool Enterprise",
...
export const networks = {
  bitcoin: {
    networkName: 'HashCash',
    title: 'HashCash Mempool',
    description: 'Explore the full HashCash ecosystem with HashCash Mempool. See the real-time status of your transactions, get network info, and more.',
    fallbackImg: '/resources/previews/mempool_og.png',
    routes: {
